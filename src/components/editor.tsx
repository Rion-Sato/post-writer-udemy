        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid w-full gap-10">
                ...
                <div className="w-[800px] mx-auto">
                    <TextareaAutoSize id="title" autoFocus defaultValue={post.title} placeholder="Post Title" className="w-full resize-none overflow-hidden bg-transparent text-5xl focus:outline-none font-bold" 
                    {...register("title")}/>
                </div>
